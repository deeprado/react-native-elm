            ...
            <View style={styles.bzContent}>
              <View style={styles.between}>
                ...
                <View style={styles.tagBox}>
                  ...
                  {piao ? (
                    <Text style={[styles.label, {marginLeft: 2}]}>{'票'}</Text>
                  ) : null}
                </View>
              </View>
                ...
                <View style={{flexDirection: 'row', flex: 1}}>
                  <View>
                    ...
                    <View
                      ...
                      <Image
                        source={LocalImgs.star1}
                        style={{height: 10, width: 55}}
                      />
                    </View>
                  </View>
                  <Text style={{fontSize: px2dp(11), color: '#ff6000'}}>
                    {scores}
                  </Text>
                  <Text style={styles.saleTxt}>{`月售${sale}单`}</Text>
                </View>
                <View style={styles.sendBox}>
                  {ontime ? (
                    <Text style={styles.label1}>{'准时达'}</Text>
                  ) : null}
                  {fengniao ? (
                    <Text style={[styles.label2, {marginLeft: 2}]}>
                      {'蜂鸟专送'}
                    </Text>
                  ) : null}
                </View>
...
const styles = StyleSheet.create({
  ...
  sendBox: {flexDirection: 'row', justifyContent: 'flex-end'},
  label: {
    fontSize: 10,
    color: '#999',
    borderWidth: 1,
  ...
  activityBox: {flexDirection: 'row', marginTop: 5},
  activityKey: {
    fontSize: px2dp(11),
    color: '#fff',
    paddingHorizontal: 1,
  ...
  activityTxt: {fontSize: px2dp(11), marginLeft: 3, color: '#666'},
  brandTxtBox: {flexDirection: 'row', flex: 1},
  tagBox: {
    flexDirection: 'row',
